...
{
    private const VERSION = '0ec7d2247d49b7e2c6762989678c9d45012b2e15';
    ...
    {
        $markdown = htmlspecialchars($bindingsMarkdown, ENT_QUOTES, 'UTF-8');

        return '<pre id="src">' . $markdown . '</pre>' . "\n" . '<div id="view"></div>'
